    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return chatUserManager.getSettingMsgSpeaker();
            }
            
            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return chatUserManager.getSettingMsgVibrate();
            }
            
            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return chatUserManager.getSettingMsgSound();
            }
            
            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if(message == null){
                    return chatUserManager.getSettingMsgNotification();
                }
                if(!chatUserManager.getSettingMsgNotification()){
                    return false;
                }else{
                    //如果允许新消息提示
                    //屏蔽的用户和群组不提示用户
                    ...
                    if (message.getChatType() == ChatType.Chat) {
                        ...
                        notNotifyIds = chatUserManager.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = chatUserManager.getDisabledGroups();
                    }
...
//                }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = chatUserManager.isGroupsSynced();
        isContactsSyncedWithServer = chatUserManager.isContactSynced();
        isBlackListSyncedWithServer = chatUserManager.isBacklistSynced();
	...
	public ChatUserManager getModel(){
        return (ChatUserManager) chatUserManager;
    }
    ...
    public void saveContact(EaseUser user){
    	...
    	chatUserManager.saveContact(user);
    }
    ...
    public Map<String, EaseUser> getContactList() {
        if (isLoggedIn() && contactList == null) {
            contactList = chatUserManager.getContactList();
        }
    ...
    public void setCurrentUserName(String username){
    	...
    	chatUserManager.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
    	if(username == null){
    		username = chatUserManager.getCurrentUserName();
    	}
    	return username;
    }
	...
	public Map<String, RobotUser> getRobotList() {
		if (isLoggedIn() && robotList == null) {
			robotList = chatUserManager.getRobotList();
		}
		return robotList;
	}
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
         ...
         chatUserManager.saveContactList(mList);
    }
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   chatUserManager.setGroupsSynced(true);
                   ...
                   chatUserManager.setGroupsSynced(false);
       ...
       new Thread(){
           ...
           public void run(){
               ...
               try {
                   ...
                   chatUserManager.setContactSynced(true);
                   ...
                   chatUserManager.setContactSynced(false);
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   chatUserManager.setBlacklistSynced(true);
                   ...
                   chatUserManager.setBlacklistSynced(false);
